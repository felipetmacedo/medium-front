...
!(function () {
  ...
  function b() {
    try {
      ...
      throw new Error(
        "Please install moment via npm. Please reference to: https://github.com/urish/angular-moment"
      );
    }
  }
  function c(c, d) {
    if ("undefined" == typeof d) {
      if ("function" != typeof require)
        throw new Error(
          "Moment cannot be found by angular-moment! Please reference to: https://github.com/urish/angular-moment"
        );
      d = b();
    }
    return (
            ...
            return function (g, h, i) {
              ...
              function l(a) {
                var c = j().diff(a, v),
                  d = t && c >= t;
                if (
                  (d ? h.text(a.format(u)) : h.text(a.from(j(), r)),
                  s && z && h.attr("title", a.format(s)),
                  !d)
                ) {
                  var e = Math.abs(j().diff(a, "minute")),
                    f = 3600;
                  e < 1 ? (f = 1) : e < 60 ? (f = 30) : e < 180 && (f = 300),
              ...
              g.$watch(x, function (b) {
                return a(b) || "" === b
                  ? (k(), void (o && (h.text(""), m(""), (o = null))))
                  : ((o = b), void n());
              }),
                c.isDefined(i.amFrom) &&
                  g.$watch(i.amFrom, function (b) {
                    (p = a(b) || "" === b ? null : d(b)), n();
                  }),
                c.isDefined(i.amWithoutSuffix) &&
                  g.$watch(i.amWithoutSuffix, function (a) {
                    "boolean" == typeof a
                      ? ((r = a), n())
                      : (r = f.withoutSuffix);
                  }),
        ...
        .service("amMoment", [
          ...
          function (a, b, d, e) {
            ...
            (this.changeLocale = function (d, e) {
              var f = a.locale(d, e);
              return (
                c.isDefined(d) && b.$broadcast("amMoment:localeChanged"), f
              );
            }),
              (this.changeTimezone = function (c) {
                a.tz && a.tz.setDefault
                  ? (a.tz.setDefault(c),
                    b.$broadcast("amMoment:timezoneChanged"))
                  : d.warn(
              ...
              (this.preprocessDate = function (b) {
                return (
                  f !== e.timezone && this.changeTimezone(e.timezone),
                  e.preprocess
                    ? e.preprocess(b)
                    : a(
        ...
        .filter("amTimeAgo", [
          ...
          function (b, c, d) {
            function e(d, e, f) {
              ...
              return a(d)
                ? ""
                : ((d = c.preprocessDate(d)),
                  (g = b(d)),
                  g.isValid()
                    ? ((h = b(f)),
                      !a(f) && h.isValid() ? g.from(h, e) : g.fromNow(e))
                    : "");
            }
            return (e.$stateful = d.statefulFilters), e;
          },
  ...
  "function" == typeof define && define.amd
    ? define(["angular", "moment"], c)
    : "undefined" != typeof module &&
      module &&
      module.exports &&
      "function" == typeof require &&
      !d
    ? (module.exports = c(require("angular"), require("moment")))
    : c(
        angular,
        ("undefined" != typeof global && "undefined" != typeof global.moment
          ? global
          : window
        ).moment
      );
